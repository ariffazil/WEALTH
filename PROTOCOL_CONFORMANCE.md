...
|------------|--------|----------|
| llms.txt | ✅ | `/root/WEALTH/llms.txt` — 8 public MCP tools, compute-only |
| tools/list | ✅ | `:18082` — 8 canonical tools loaded; no institutional compatibility registrations |
| health endpoint | ✅ | `:18082/health` — distinguishes live tool count and source SHA from declared or unverified fallback metadata |
| Surface audit | ✅ | Source registration and manifests declare the same 8-tool surface |

## FastMCP Conformance
| Requirement | Status | Evidence |
|------------|--------|----------|
| FastMCP server | ✅ | Python 3.12 FastMCP runtime on port 18082 |
| Resource discovery | ✅ | MCP resources available — capital models and governance context |
...
| Resource schema | ✅ | MCP resources via FastMCP — capital models and governance context |
...
- 8 operational public tools, zero source-manifest drift
...
---
Generated: 2026-08-03 · Authority: AAA Control Plane
