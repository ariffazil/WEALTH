...
Usage:
    ...
    python3 fetch_gold.py snapshot
...
def cmd_snapshot(args):
    ...
    cached = _read_cache(cache)
    if cached and cached.get("schema") == "wealth.snapshot.v1" and cached.get("asset") == "gold":
        return cached
    ...
    try:
        ...
        result = build_snapshot("gold", ticker, levels, macro, observed_at)
