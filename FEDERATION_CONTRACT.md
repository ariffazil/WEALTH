...
| **Port** | 18082 |
| **Role** | Compute-only capital engine |
| **Floors enforced** | F1 AMANAH, F2 TRUTH, F6 EMPATHY |
| **License** | AGPL-3.0 |

## Boundaries

**OWNS:** NPV, IRR, EMV, DSCR, risk scores, portfolio allocation models, market data, stock analysis.
**NEVER:** Move capital, authorize trades, adjudicate constitutional verdicts, allocate resources without 888.
